...
if ('BG' %in% unique(labs.df$PROC_NAME))
  timeThresholdGraph(df = labs.df, PN = c('CBC', 'BG'), CN = 'Hgb')

if ('ISTAT' %in% unique(labs.df$PROC_NAME))
  timeThresholdGraph(df = labs.df, PN = c('CBC', 'ISTAT'), CN = 'Hgb')
```
