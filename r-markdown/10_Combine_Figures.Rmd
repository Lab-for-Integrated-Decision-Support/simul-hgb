...
ggplot2::ggsave(
  ...
  plot = Figure_2,
  width = 8, height = 6, units = 'in', dpi = dpi, compression = compress)
```
...
Supp_Figure_NonParamBA <- 
  cowplot::plot_grid(
    ...
    URMC.BA.BG$qq.plot + 
      ggtitle('URMC BG Original Q:Q Plot') +
      theme(
        #axis.title.x = element_blank()
      ),    
    ...
    URMC.BA.NP.BG$qq.plot + 
      ggtitle('URMC BG Non-Parametric Q:Q Plot') +
      theme(
        #legend.position = 'none'
      ),
    CHOP.BA.NP.BG$plot +
    ...
    URMC.BA.NP.BG$plot +
      ylim(c(-4, 4)) +
      ggtitle('URMC Non-Parametric B-A Plot') +
      theme(
        #axis.title.x = element_blank()
      ),    
    labels = tolower(LETTERS[1:6]), 
...
Supp_Figure_Temporal_4q <- 
  cowplot::plot_grid(
    ...
    URMC.RESTRICT[[1]] + 
      ggtitle('URMC - Restricted Points') +
      theme(
        title = element_text(size = 12)        
        #axis.title.x = element_blank()
      ),     
